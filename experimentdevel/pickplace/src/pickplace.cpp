...
void pick(moveit::planning_interface::MoveGroupInterface& move_group)
{
  ...
  // Setting grasp pose
  grasps[0].grasp_pose.header.frame_id = "flange";
  tf2::Quaternion orientation;
  orientation.setRPY(M_PI / 2, 0, -M_PI / 2);
  grasps[0].grasp_pose.pose.orientation = tf2::toMsg(orientation);
  grasps[0].grasp_pose.pose.position.x = 0.7;
  ...
  grasps[0].pre_grasp_approach.direction.header.frame_id = "flange";
  ...
  // ++++++++++++++++++++++++++
  /* Defined with respect to frame_id */
  grasps[0].post_grasp_retreat.direction.header.frame_id = "flange";
...
void place(moveit::planning_interface::MoveGroupInterface& group)
{
  ...
  // +++++++++++++++++++++++++++
  place_location[0].place_pose.header.frame_id = "flange";
  tf2::Quaternion orientation;
  orientation.setRPY(M_PI / 2, 0, -M_PI / 2);
  ...
  // ++++++++++++++++++++++++++
  /* Defined with respect to frame_id */
  place_location[0].pre_place_approach.direction.header.frame_id = "flange";
  ...
  // ++++++++++++++++++++++++++
  /* Defined with respect to frame_id */
  place_location[0].post_place_retreat.direction.header.frame_id = "flange";
...
{
  ros::init(argc, argv, "ur5_pickplace");
  ros::NodeHandle nh;
